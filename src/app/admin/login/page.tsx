...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] py-8 px-4 sm:px-6 md:py-12 md:px-8 flex items-center justify-center relative">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="glass-card rounded-2xl p-6 sm:p-8 md:p-10 border border-slate-200 dark:border-white/10 shadow-2xl relative overflow-hidden backdrop-blur-2xl bg-white/40 dark:bg-black/40">
