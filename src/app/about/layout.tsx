...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://samstack.tech/about",
    languages: { 'en': 'https://samstack.tech/about' },
  },
  openGraph: {
    title: "About SAMStack Tech | Our Mission, Team & Story",
  ...
  "@graph": [
    {
      ...
      "breadcrumb": {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "About", "item": "https://samstack.tech/about" }
        ]
      }
    },
    {
      "@type": "Person",
      "@id": "https://samstack.tech/about#founder",
      "name": "Suleman Zaheer",
      "givenName": "Suleman",
      "familyName": "Zaheer",
