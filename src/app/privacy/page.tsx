      ...
      <section className="z-0 overflow-hidden relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8 border-t border-slate-100 dark:border-neutral-900 group">
          ...
          <div className="flex-1 min-w-0">
            <div className="max-w-3xl space-y-12">
              ...
              <AnimateOnScroll variant="fadeUp" delay={0.05}>
                <section id="collection" className="z-0 overflow-hidden relative space-y-5 scroll-mt-20 group">
        <div className="z-10 relative flex items-center gap-3">
              ...
              <AnimateOnScroll variant="fadeUp" delay={0.1}>
                <section id="protection" className="z-0 overflow-hidden relative space-y-5 scroll-mt-20 group">
        <div className="z-10 relative flex items-center gap-3">
              ...
              <AnimateOnScroll variant="fadeUp" delay={0.15}>
                <section id="rights" className="z-0 overflow-hidden relative space-y-5 scroll-mt-20 group">
        <div className="z-10 relative flex items-center gap-3">
        ...
        <h3 className="text-2xl font-bold text-slate-900 dark:text-white font-heading">5. Contact Us</h3>
                  ...
                  <div className="bg-white dark:bg-neutral-950 rounded-xl p-5 border border-slate-200 dark:border-neutral-800 shadow-sm">
                    <p className="font-mono text-sm text-slate-900 dark:text-slate-100">privacy@samstack-tech.vercel.app</p>
                  </div>
                </section>
              </AnimateOnScroll>
